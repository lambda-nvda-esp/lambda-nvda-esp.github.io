...
BLOG_AUTHOR = "Organización de GitHub lambda-nvda-esp"  # (translatable)
BLOG_TITLE = "LAMBDA con NVDA en español"  # (translatable)
# This is the main URL for your site. It will be used
# in a prominent link. Don't forget the protocol (http/https)!
SITE_URL = "https://lambda-nvda-esp.github.io/"
# This is the URL where Nikola's output will be deployed.
# If not set, defaults to SITE_URL
# BASE_URL = "https://lambda-nvda-esp.github.io/"
BLOG_EMAIL = "lambda-nvda+owners@googlegroups.com"
BLOG_DESCRIPTION = "sitio sobre la organización lambda-nvda-esp y el uso de LAMBDA con NVDA en español"  # (translatable)
...
POSTS = (
    ("posts/*.md", "a", "post.tmpl"),
    ("posts/*.rst", "a", "post.tmpl"),
    ("posts/*.txt", "a", "post.tmpl"),
    ("posts/*.html", "a", "post.tmpl"),
)
PAGES = (
    ("pages/*.md", "p", "story.tmpl"),
    ("pages/*.rst", "p", "story.tmpl"),
    ("pages/*.txt", "p", "story.tmpl"),
    ("pages/*.html", "p", "story.tmpl"),
)
...
# Default is:
FILES_FOLDERS = {'files': '', 'linked_files': 'linked_files'}
